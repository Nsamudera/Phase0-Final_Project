...
var victory= new Audio('Asset/Victory.mp3')
var defeat = new Audio('Asset/Defeat.mp3')
function hitCompSound (){
    var atkSound = new Audio('Asset/strike.mp3')
    atkSound.play()
    atkSound.currentTime=0
}
function hitRecSound (){
    var gotHit = new Audio('Asset/gothit.mp3')
    gotHit.play()
    gotHit.currentTime=0
}
function spcHit (){
    var spcSound = new Audio('Asset/skill.mp3')
    spcSound.play()
